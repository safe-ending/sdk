package com.nq.edusaas.hps.activity.base;
...
import com.nq.edusaas.hps.utils.PenOSUtil;
...
public class StatusBarHelper {
     ...
     * 设置 状态栏深色浅色切换
     */
    public static boolean setStatusBarFontIconDark(AppCompatActivity activity, boolean dark) {
        if (PenOSUtil.isMiui()) {
            return setMiuiUI(activity, dark);
        } else if (PenOSUtil.isFlyme()) {
    ...
    //设置Flyme 状态栏深色浅色切换
    private static boolean setFlymeUI(AppCompatActivity activity, boolean dark) {
        try {
            Window window = activity.getWindow();
    ...
    //设置MIUI 状态栏深色浅色切换
    private static boolean setMiuiUI(AppCompatActivity activity, boolean dark) {
        try {
            Window window = activity.getWindow();
