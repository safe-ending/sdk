...
public class SpinMenuAnimator {
    ...
    public static final String TAG = SpinMenuAnimator.class.getSimpleName();
    ...
    public void openMenuAnimator() {
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                Log.d(TAG, "openMenuAnimator()-onAnimationEnd");
                ...
                Log.e(TAG, "open menu anim end showingPager.width=" + showingPager.getWidth() + ", showingPager.height=" + showingPager.getHeight()+
                ", tranX="+tranX+", tranY="+tranY);
    ...
    public void closeMenuAnimator(SMItemLayout chooseItemLayout) {
        ...
        Log.e(TAG, "close menu anim pagerLayout.width=" + pagerLayout.getWidth() + ", pagerLayout.height=" + pagerLayout.getHeight()+
                ", currTranX="+currTranX+", currTranY="+currTranY);
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                Log.d(TAG, "closeMenuAnimator()-onAnimationEnd");
                if (onSpinMenuStateChangeListener != null) {
