package com.nq.edusaas.hps.sdkcore.afpensdk.bean;//package com.nq.edusaas.hps.sdkcore.afpensdk.bean;
//
...
//                                    (lastDot.x == penPoint.x && Math.abs(lastDot.y - penPoint.y) < 15) ||
//                                    (lastDot.y == penPoint.y && Math.abs(lastDot.x - penPoint.x) < 15) || dis < 6)) {
//                                continue;
//                            }
...
////                                    L.error("lineTo x=" + pts.get(ctr).x + " y=" + pts.get(ctr).y);
//                                } else {
