...
package com.eningqu.aipen.zxing;
...
public final class ViewfinderView extends View {
    ...
    private Paint paint, scanLinePaint, reactPaint, frameLinePaint, textPaint, textBgPaint;
    ...
    private int textBgtColor;//文字背景颜色
    ...
    public ViewfinderView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        textBgtColor = ContextCompat.getColor(getContext(), R.color.dialog_title_text);
    ...
    private void initPaint() {
        ...
        textPaint.setColor(reactColor);
        textPaint.setStyle(Paint.Style.FILL);
        textPaint.setStrokeWidth(dp2px(15));
        textPaint.setTextSize(dp2px(15));
        textPaint.setTextAlign(Paint.Align.CENTER);

        /*文字背景画笔*/
        textBgPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        textBgPaint.setColor(textBgtColor);
        textBgPaint.setStyle(Paint.Style.FILL);
        textBgPaint.setStrokeWidth(dp2px(15));
...
//            drawScanLight(canvas, frame);
    ...
    private void drawText(Canvas canvas, Rect frame) {
        ...
        float textWidth = textPaint.measureText(getContext().getString(R.string.str_scan_server_qr_code));

        float distance = (fontMetrics.bottom - fontMetrics.top) / 2 - fontMetrics.bottom;
        float baseline = frame.top - distance - dp2px(20);

        Rect textBgRect = new Rect(
                (int) (frame.centerX() - textWidth / 2 - dp2px(15)),
                (int) (baseline - dp2px(14) - dp2px(9)),
                (int) (frame.centerX() + textWidth / 2 + dp2px(15)),
                (int) (baseline) + dp2px(11));
//        canvas.drawRect(textBgRect, textBgPaint);
//        Path path = new Path();
//        int diameter = textBgRect.bottom - textBgRect.top;
//        path.addArc(new RectF(textBgRect.right - diameter / 2, textBgRect.top, textBgRect.right + diameter / 2, textBgRect.bottom), -90, 180);
//        path.lineTo(textBgRect.left, textBgRect.bottom);
//        path.addArc(new RectF(textBgRect.left - diameter / 2, textBgRect.top, textBgRect.left + diameter / 2, textBgRect.bottom), 90, 180);
//        path.close();
//        canvas.drawPath(path, textBgPaint);


        canvas.drawText(getContext().getString(R.string.str_scan_server_qr_code), textBgRect.centerX(), ScreenUtils.getScreenHeight() - textBgRect.centerY() - distance, textPaint);
    }
