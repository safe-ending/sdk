...
public final class ToastUtils {
    ...
    private static final int COLOR_DEFAULT = 0x000000;
...
//        }
    ...
    private static void setBg(final TextView tvMsg) {
        ...
        try {
            ...
            tvBg.setColorFilter(new PorterDuffColorFilter(Color.BLACK, PorterDuff.Mode.SRC_IN));
    ...
    static class ToastWithoutNotification extends AbsToast {
        ...
        private void realShow() {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N_MR1) {
                ...
                ActivityUtils.addActivityLifecycleCallbacks(topActivity, getActivityLifecycleCallbacks());
            }
