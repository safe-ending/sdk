...
//        jumpView = findViewById(R.id.jump);
//        welcome_img = findViewById(R.id.welcome_img);
//        jumpView.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Boolean isAgree = SpUtils.getBoolean(WelcomeActivity.this, Constant.SP_KEY_USER_AGREE, false);
//                if(isAgree){
...
//            }
//        });
//        welcome_img.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//
//            }
