...
//                        }
    ...
    protected void onResume() {
        ...
        Log.e("caiyunsdk","SP_KEY_INIT_PEN" + initPen);
        ...
        Log.e("caiyunsdk","loadUserInfo" + userInfoData.userName);
...
//    }
    ...
    public void itemClick(int ResId) {
        if (ResId == R.string.drawer_home) {
            mainBinding.drawerLayout.closeDrawer(GravityCompat.START);
            //                pushFragment(MainFragment.newInstance());
            switchFragment(mainFragment);
        } else if (ResId == R.string.drawer_note_collect) {
            gotoActivity(CollectActivity.class);
        } else if (ResId == R.string.calendar_text) {
            gotoActivity(CalendarSearchActivity.class);
        } else if (ResId == R.string.label_text) {
            gotoActivity(NotebookDisplayVerticalActivity.class);
        } else if (ResId == R.string.drawer_search) {
            gotoActivity(NoteSearchActivity.class);
        } else if (ResId == R.string.drawer_ble_scan) {
            if (!ble.connectStatus) {
                gotoActivity(DeviceLinkGuideActivity.class);
            } else {
                showToast(R.string.collect_success_msg);
            }
        } else if (ResId == R.string.drawer_setting) {
            gotoActivity(SettingActivity.class);
        } else if (ResId == R.string.drawer_operating) {
            Bundle bundle = new Bundle();
            bundle.putInt(WebViewActivity.TYPE_KEY, WebViewActivity.WEB_VIEW_TYPE_INT);
            gotoActivity(WebViewActivity.class, bundle);
        } else if (ResId == R.string.drawer_cloud_backups) {
            showToast(R.string.developing);
            mainBinding.drawerLayout.closeDrawer(GravityCompat.START);
        } else if (ResId == R.string.user_agreement_title2) {
            Bundle bundle = new Bundle();
            bundle.putInt(WebViewActivity.TYPE_KEY, WebViewActivity.WEB_VIEW_TYPE_PRO2);
            gotoActivity(WebViewActivity.class, bundle);
        } else if (ResId == R.string.drawer_data_migration) {
        ...
        if (null != carrier) {
            switch (carrier.getEventType()) {
                ...
                case Constant.NQ_SER_AUTH_FAIL:
                    ...
                    if (anInt == -1) {
                        ToastUtils.showShort(getResources().getString(R.string.pen_error));
                    } else if (anInt == -2) {
                        ToastUtils.showShort(getResources().getString(R.string.str_network_error2));
                    }
