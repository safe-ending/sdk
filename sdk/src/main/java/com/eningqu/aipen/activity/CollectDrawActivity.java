...
public class CollectDrawActivity extends BaseActivity implements PlatformActionListener {
    ...
    protected void initView() {
        layoutLabel = findViewById(R.id.layout_label);
        layoutTop = findViewById(R.id.ll_top);
        imageView = findViewById(R.id.iv_draw_board);
        pageTV = findViewById(R.id.tv_page_num);
        ...
        findViewById(R.id.iv_label_add).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.iv_draw_board).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (isShowLabel) {
