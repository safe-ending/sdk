...
public class PageStrokesCacheBean {
     ...
     * @param color 颜色
     */
    public synchronized void addStrokes(Point pt, int type, float size, int color, long lastTime) {
        ...
        if (type == 1) {
            ...
            mStrokesBean.setSizeLevel(CommandSize.getSizeLevelBySize(size));
            mStrokesBean.setCreateTime(lastTime);
